...
5. **Upload Assets**
   - Run `gh release upload [VERSION_TAG] "dist/[FILENAME]" -R jinyaodl/iwantacake` for the APK.
   - Run `gh release upload [VERSION_TAG] "dist/icon.png" -R jinyaodl/iwantacake` for the icon.
